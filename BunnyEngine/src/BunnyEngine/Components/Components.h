...
#include "BunnyEngine/Core/GUID.h"
#include "BunnyEngine/Camera/SceneCamera.h"
#include "BunnyEngine/Math/Math.h"
#include "BunnyEngine/Renderer/Material.h"
#include "BunnyEngine/Renderer/SubTexture2D.h"
#include "BunnyEngine/Classes/StaticMesh.h"
#include "BunnyEngine/Physics/PhysicsMaterial.h"
#include "BunnyEngine/Audio/Sound3D.h"
#include "BunnyEngine/Audio/Reverb3D.h"
//#include "BunnyEngine/Physics/PhysicsShapes.h"
...
namespace BE
{
	...
	public:
		...
		OwnershipComponent& operator= (const OwnershipComponent& other)
		{
			...
			BE_CORE_ASSERT(srcScene, "Empty src Scene");
			BE_CORE_ASSERT(destScene, "Empty dest Scene");
			BE_CORE_ASSERT(srcScene != destScene, "Scene's are equal");
	...
	public:
		...
		void Bind()
		{
			BE_CORE_ASSERT(InitScript == nullptr, "Initialized Script twice!");
